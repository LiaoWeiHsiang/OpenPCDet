...
class ProposalTargetLayer(nn.Module):
    ...
    def sample_rois_for_rcnn(self, batch_dict):
        ...
        for index in range(batch_size):
            ...
            # print(cur_gt[gt_assignment[sampled_inds]])
            # =========change this from cur_gt[gt_assignment[sampled_inds]] to cur_gt[gt_assignment[sampled_inds]][:,[0,1,2,3,4,5,6,9]]
            batch_gt_of_rois[index] = cur_gt[gt_assignment[sampled_inds]][:,[0,1,2,3,4,5,6,9]]
            # ======
