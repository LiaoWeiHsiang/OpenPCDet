...
class NuScenesDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        self.nusc = NuScenes(version='v1.0-mini', dataroot='/home/950154_customer/david/OpenPCDet/data/nuscenes/v1.0-mini', verbose=True)
...
#        import sys, os
        ...
        blockPrint()
        # nusc = NuScenes(version='v1.0-trainval', dataroot='/home/950154_customer/david/OpenPCDet/data/nuscenes/v1.0-trainval', verbose=True)
        nusc = self.nusc
        enablePrint()
